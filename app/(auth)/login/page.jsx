...
return (
  <section className="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center px-6 py-8">
    ...
    className="flex items-center  border border-gray-300 bg-gray-200 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
